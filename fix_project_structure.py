#!/usr/bin/env python3
"""
Script to fix the Xcode project structure
"""
...
def fix_project():
    ...
    # Fix 1: Remove files from root group (lines 70-75)
    ...
    # Fix 2: Add files to DualCameraApp group (before the closing parenthesis)
    ...
    # Fix 3: Add files to Sources build phase (before the closing parenthesis)
    ...
    print("Fixed Xcode project structure")
