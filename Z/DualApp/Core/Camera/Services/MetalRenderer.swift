...
class MetalRenderer: NSObject, Sendable {
    ...
    func renderFrame(_ frame: DualCameraFrame, to view: MTKView) async throws {
        ...
        // Actor provides synchronization
    ...
    func setViewportSize(_ size: CGSize) async {
        ...
        do {
            ...
            // Handle render target creation error
            print("Failed to create render targets: \(error)")
        }
    }
    ...
    private func createRenderPipeline() async throws {
        ...
        renderPipelineState = try await device.makeRenderPipelineState(descriptor: pipelineDescriptor)
    }
    ...
    private func createComputePipeline() async throws {
        ...
        computePipelineState = try await device.makeComputePipelineState(function: computeFunction!)
    }
    ...
    private func performCompositeRendering(commandBuffer: MTLCommandBuffer) async throws {
    ...
    private func applyPostProcessingEffects(commandBuffer: MTLCommandBuffer) async throws {
