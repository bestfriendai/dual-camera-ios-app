...
final class PermissionCoordinator {
    ...
    func requestAllPermissions() async -> (granted: Bool, denied: [PermissionType]) {
        state = .requesting
    ...
    func presentPermissionPrimer(from viewController: UIViewController, completion: @escaping () -> Void) {
