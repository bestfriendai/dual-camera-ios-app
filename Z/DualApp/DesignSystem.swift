...
class DesignSystem {
    ...
    static func optimizeGlassView(_ view: UIView, forPerformance level: PerformanceLevel) {
        switch level {
        case .high:
    ...
    static func optimizeLayerForAnimation(_ layer: CALayer, isAnimating: Bool) {
        if isAnimating {
